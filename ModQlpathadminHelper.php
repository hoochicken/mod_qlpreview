...
class ModQlpathadminHelper
{
    ...
    public function generateUrlsByMenuItemId(int $id): void
    {
        ...
        if (is_null($menuItem)) {
            throw new Exception('qlpathadmin: MenuItem konnte nicht gefunden werden.');
        }
    ...
    {
        return $this->getButtonLabel('raw_url_label', 'MOD_QLPATHADMIN_RAWLINK_BUTTON_LABEL');
    }

    public function getIndexButtonLabel(): string
    {
        return $this->getButtonLabel('index_url_label', 'MOD_QLPATHADMIN_INDEXLINK_BUTTON_LABEL');
    }

    public function getSefButtonLabel(): string
    {
        return $this->getButtonLabel('sef_url_label', 'MOD_QLPATHADMIN_SEFLINK_BUTTON_LABEL');
    }
